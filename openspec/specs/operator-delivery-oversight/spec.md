# Operator Delivery Oversight — Spec (folded from P26)

Product rationale: [`../../../docs/prd/P26-operator-console-refresh.md`](../../../docs/prd/P26-operator-console-refresh.md)
§6 (FR48–FR52). Technical decisions: [`../../changes/archive/2026-08-01-p26-operator-console-refresh/design.md`](../../changes/archive/2026-08-01-p26-operator-console-refresh/design.md) D2, D9.
