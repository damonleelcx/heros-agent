# Operator Surface Ledger — Spec (folded from P26)

Product rationale: [`../../../docs/prd/P26-operator-console-refresh.md`](../../../docs/prd/P26-operator-console-refresh.md)
§6 (FR42–FR47), §8.2 D1. Technical decisions: [`../../changes/archive/2026-08-01-p26-operator-console-refresh/design.md`](../../changes/archive/2026-08-01-p26-operator-console-refresh/design.md) D1, D7, D8.
