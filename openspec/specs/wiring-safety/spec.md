...
|---|---|---|
| Validation precedes any codemod | [`variantspec/rearrange.go`](../../../internal/variantspec/rearrange.go) `GateReorder`; [`proposal/gate.go`](../../../internal/proposal/gate.go) delegates to it | `TestReorderCandidatesAreGated` |
| Incoherent ordering rejected at compile | `GateReorder` returns `(nil, verdict)` | `TestIncoherentWiringRejectedAtCompile`, `TestGateReorder_RejectedYieldsNoRunnableSpec` |
| Adapter recorded + edges rewired | [`variantspec/rearrange.go`](../../../internal/variantspec/rearrange.go) `withAdapters` | `TestAdaptedVerdictRecordsAdapter`, `TestGatedAdaptedCandidateCarriesAdapter` |
| Adapter drops nothing required | [`typedcontract/adapter.go`](../../../internal/typedcontract/adapter.go) `FindAdapter` re-validates both schemas | `TestAdapterDropsNothingRequired`, `TestSatisfyingAdapterIsAdmitted` |
| Adapter ships in the same diff | [`transform/adapteremit.go`](../../../internal/transform/adapteremit.go) + [`generatetransform.go`](../../../internal/transform/generatetransform.go) | `TestAdapterIsInReviewableDiff` |
| Deterministic adapter identity | `adapterNodeID(from,to,kind)`; fixed catalog match order | `TestAdapterIdentityDeterministic`, `TestAdapterCatalogOrderIsFixed` |
