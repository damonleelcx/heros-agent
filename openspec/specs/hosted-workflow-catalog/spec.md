# Hosted Workflow Catalog — Spec (folded from P29)

Product rationale: [`../../../docs/prd/P29-linked-run-fanout.md`](../../../docs/prd/P29-linked-run-fanout.md)
§6 (FR46–FR55). Design reasoning: [`../../changes/archive/2026-08-07-p29-linked-run-fanout/design.md`](../../changes/archive/2026-08-07-p29-linked-run-fanout/design.md) D4, D7.
