# Linked Subject Index — Spec (folded from P29)

Product rationale: [`../../../docs/prd/P29-linked-run-fanout.md`](../../../docs/prd/P29-linked-run-fanout.md)
§6 (FR21–FR30). Design reasoning: [`../../changes/archive/2026-08-07-p29-linked-run-fanout/design.md`](../../changes/archive/2026-08-07-p29-linked-run-fanout/design.md) D3, D5.
