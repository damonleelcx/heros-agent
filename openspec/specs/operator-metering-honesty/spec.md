# Operator Metering Honesty — Spec (folded from P26)

Product rationale: [`../../../docs/prd/P26-operator-console-refresh.md`](../../../docs/prd/P26-operator-console-refresh.md)
§6 (FR65–FR69). Technical decisions: [`../../changes/archive/2026-08-01-p26-operator-console-refresh/design.md`](../../changes/archive/2026-08-01-p26-operator-console-refresh/design.md) D5, D9.
