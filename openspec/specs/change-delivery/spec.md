# Change Delivery — Spec (folded from P13)
...
Design reasoning: [`../../changes/archive/2026-08-01-p13-prompt-model-optimization/design.md`](../../changes/archive/2026-08-01-p13-prompt-model-optimization/design.md) Decision 14.
...
[`skill-tool-delivery`](../skill-tool-delivery/spec.md) (P14),
[`wiring-delivery`](../wiring-delivery/spec.md) (P15),
[`context-delivery`](../context-delivery/spec.md) (P16),
[`memory-delivery`](../memory-delivery/spec.md) (P17), and
[`harness-delivery`](../../changes/p18-harness-strategy-optimization/specs/harness-delivery/spec.md) (P18).

It consumes, and does not modify, [`forge-delivery`](../forge-delivery/spec.md) and
[`delivery-record`](../delivery-record/spec.md) (P12).
...
under [`forge-delivery`](../forge-delivery/spec.md) — and the **runtime route** — a
