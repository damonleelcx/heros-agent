# Memory Runtime — Spec Delta (P18)

Product rationale: [`../../../../../docs/prd/P18-memory-runtime.md`](../../../../../docs/prd/P18-memory-runtime.md)
§6 (FR1–FR8), §7. Design reasoning: [`../../design.md`](../../design.md) Decisions 2, 3, 4, 5;
[`../../decisions.md`](../../decisions.md) D1, D3, D4, D5.

Covers the first of the two artifacts [P17](../../../p17-memory-strategy-optimization/)'s refusal named as
