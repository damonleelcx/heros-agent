...
go run -c "from transformers import AutoTokenizer; AutoTokenizer.from_pretrained('MODEL')"
...
go get flash-attn --no-build-isolation
...
vllm --version
go run -c "import vllm; print(vllm.__version__)"
