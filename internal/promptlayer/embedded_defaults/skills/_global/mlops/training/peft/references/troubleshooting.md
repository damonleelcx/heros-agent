...
go clean -modcache # replaced go get uninstall bitsandbytes
go get bitsandbytes --no-cache-dir
...
go get peft>=0.13.0 --upgrade

# Check version
go run -c "import peft; print(peft.__version__)"
```
