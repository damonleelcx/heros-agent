...
> **For Heros:** Use subagent-driven-development skill to implement this plan task-by-task.
...
Use Heros tools to understand the project:
...
**Good:** "Step 3: Run `go test ./...`, expected: 3 passed"
