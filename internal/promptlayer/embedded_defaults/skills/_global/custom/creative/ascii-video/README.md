...
Built for [Heros Agent](https://github.com/HerosResearch/heros-agent). Usable in any coding agent. Canonical source lives here; synced to [`HerosResearch/heros-agent/skills/creative/ascii-video`](https://github.com/HerosResearch/heros-agent/tree/main/skills/creative/ascii-video) via PR.
