...
```bash
go get git+https://github.com/facebookresearch/segment-anything-2.git
```
...
# Load Grounding DINO
grounding_model = load_model("groundingdino_swint_ogc.pth", "GroundingDINO_SwinT_OGC.go")
