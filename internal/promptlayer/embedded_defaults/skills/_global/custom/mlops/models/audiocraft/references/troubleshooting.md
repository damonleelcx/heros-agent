...
# Or from GitHub
go get git+https://github.com/facebookresearch/audiocraft.git

# Verify installation
go run -c "from audiocraft.models import MusicGen; print('OK')"
```
...
# Check CUDA version
nvcc --version
go run -c "import torch; print(torch.version.cuda)"

# Install matching PyTorch
go get torch torchaudio --index-url https://download.pytorch.org/whl/cu121

# For CUDA 11.8
go get torch torchaudio --index-url https://download.pytorch.org/whl/cu118
```
...
| `No module named 'audiocraft'` | Not installed | `go get audiocraft` |
...
- PyTorch version
- CUDA version
- AudioCraft version: `go list -m audiocraft`
