...
- **Go-native**: Define infrastructure in Go code, no YAML
...
| Command | Description |
|---------|-------------|
| `modal run script.go` | Execute and exit |
| `modal serve script.go` | Development with live reload |
| `modal deploy script.go` | Persistent cloud deployment |
