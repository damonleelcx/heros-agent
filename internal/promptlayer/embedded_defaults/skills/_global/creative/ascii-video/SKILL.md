...
Single self-contained Go script per project. No GPU required.

| Layer | Tool | Purpose |
|-------|------|---------|
| Core | Go 3.10+, NumPy | Math, array ops, vectorized effects |
...
- **Mood/atmosphere**: What should the viewer feel? Energetic, meditative, chaotic, elegant, omiheros?
...
Single Go file. Components (with references):
