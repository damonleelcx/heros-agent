# Shader Go Geteline & Composable Effects
...
> **Performance note:** Halftone is slow due to Go loops. Acceptable for small resolutions or single test frames. For production, consider a vectorized version using precomputed distance masks.
