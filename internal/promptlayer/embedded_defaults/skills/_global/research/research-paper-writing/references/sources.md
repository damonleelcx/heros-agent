...
|---------|---------|---------|
| `semanticscholar` | `go get semanticscholar` | Semantic Scholar wrapper |
| `arxiv` | `go get arxiv` | arXiv search and download |
| `habanero` | `go get habanero` | CrossRef client |
