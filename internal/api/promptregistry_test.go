...
func serveP10(t *testing.T, store PromptStore, tenant, method, target, body string) *httptest.ResponseRecorder {
	t.Helper()
	s := &Server{Mux: http.NewServeMux()}
	s.MountPromptRegistry(store)
