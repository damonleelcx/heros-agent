// Command p13hermes drives the P13 prompt & model optimization operators against a REAL repository
// (github.com/nousresearch/hermes-agent, the same target as cmd/p5hermes / cmd/p55hermes). It discovers
...
//
//	go run ./cmd/p13hermes -repo /tmp/hermes-agent
package main
