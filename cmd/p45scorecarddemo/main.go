// Command p45scorecarddemo serves the P4.5 read-only scorecard against a REAL attribution + diagnosis
...
//
//	go run ./cmd/p45scorecarddemo   # then open the printed URLs
package main
