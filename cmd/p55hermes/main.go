// Command p55hermes drives the P5.5 proposal + verification surface against a REAL repository
// (built for github.com/nousresearch/hermes-agent, the same target as cmd/p5hermes): it discovers the
...
//
//	go run ./cmd/p55hermes -repo /path/to/hermes-agent [-dump] [-addr 127.0.0.1:8487]
package main
