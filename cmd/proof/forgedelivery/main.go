// Command forgedelivery serves the P12 forge-delivery console read model, addressed as the REAL
...
// # Usage
//
//	go run ./cmd/proof/forgedelivery                       # serve the populated scenario on :4321
//	go run ./cmd/proof/forgedelivery -scenario no-route
//
...
func main() {
	...
	fmt.Printf("           CI-mediated    GET /api/v1/ci/pending   POST /api/v1/ci/report\n\n")
	fmt.Printf("console:\n")
