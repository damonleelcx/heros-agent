// Command distribution drives the P20 distribution against a REAL repository — nousresearch/hermes-agent — using
...
//
//	go run ./cmd/proof/distribution -repo /tmp/hermes-agent-p20 -heros /path/to/installed/heros
//
