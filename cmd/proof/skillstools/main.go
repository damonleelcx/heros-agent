// Command skillstools drives the P14 skills & tools optimization against a REAL repository
// (github.com/nousresearch/hermes-agent, the same target as cmd/proof/contracts / cmd/proof/promptmodel). It
...
// provider.
//
//	go run ./cmd/proof/skillstools -repo /tmp/hermes-agent
package main
