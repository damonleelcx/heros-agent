// Command optimizer drives the whole P6 autonomous-optimizer loop against a REAL repository
...
// cmd/proof/proposals stubs it — is the DIAGNOSIS input (in production from the P4.5 attribution engine) and
...
//
//	go run ./cmd/proof/optimizer -repo /path/to/hermes-agent [-addr 127.0.0.1:8499] [-headless]
package main
